...
public class Chat extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        ids.add(BuddyApplication.instance.currentUser.id);
        ids.add(userId);
    ...
    public void onResume() {
        ...
        BuddyApplication.activeChat = this;
    ...
    public void onPause() {
        ...
        BuddyApplication.activeChat = null;
        ...
        public void run() {
            parent.runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (BuddyApplication.activeChat != ChatUpdateTask.this.parent) {
                        return;
                    }
