...
public class SeekerList extends AppCompatActivity {
    ...
    private static final String TAG = "Seeker List";
    ...
    ArrayList<String> topicsToTeach;
    ...
    private void refreshList() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(SeekerList.this);
        progressDialog.setIndeterminate(true);
        progressDialog.setMessage("Retrieving Seekers...");
        progressDialog.show();

        Log.w(TAG, "Searching users who learn the subject");

        currentParseUser = ParseUser.getCurrentUser();

        topicsToTeach = (ArrayList<String>)currentParseUser.get("topicsToTeach");

        // Query for users within 10 miles of the users location
        ParseQuery<ParseUser> parseUserQuery = ParseUser.getQuery();
        parseUserQuery.whereContainedIn("topicsToTeach", topicsToTeach);
    ...
    class UsersSimpleAdapter extends SimpleAdapter<User> {
        ...
        protected <T> void populateView(View v, T u) {
            ...
            text1.setText(String.format("%s (Teaches %s)", user.userName, topicsToTeach));
